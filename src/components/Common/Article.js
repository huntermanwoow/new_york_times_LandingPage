    ...
    return (
        <>
            <div className="md:mt-20 mt-12 rounded-3xl bg-[#FFFFFF90] p-2 md:p-8">
                ...
                <div className="text-center md:mt-0 md:text-[24px] mb-4 font-[400] font-[Chomsky] text-[#2C231A]">
