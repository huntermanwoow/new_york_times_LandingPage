...
export default function Article() {
    return (
        <>
            ...
            <div className="md:mt-0 md:text-[26px] font-[400] font-[Chomsky] text-[#2C231A]">
